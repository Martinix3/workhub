import type { HACCPMonitorProps, HACCPPlan, CriticalControlPoint, CCPReading, CCPStatus } from '../types'
import { AlertTriangle, CheckCircle, Clock, Thermometer, Shield, Eye, Plus } from 'lucide-react'
