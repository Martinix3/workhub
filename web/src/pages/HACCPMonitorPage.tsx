    ...
    <>
      ...
      {successMessage && (
        <div className="fixed top-4 right-4 z-50 max-w-md">
          <div className="p-4 bg-green-50 border-2 border-green-500 text-green-700 shadow-[4px_4px_0_#1c1917] animate-in slide-in-from-top">
      ...
      {errorMessage && (
        <div className="fixed top-4 right-4 z-50 max-w-md">
          <div className="p-4 bg-red-50 border-2 border-red-500 text-red-700 shadow-[4px_4px_0_#1c1917] animate-in slide-in-from-top">
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
