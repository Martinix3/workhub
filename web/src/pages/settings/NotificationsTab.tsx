...
export function NotificationsTab() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-medium text-neutral-900 mb-1">Notificaciones</h3>
        ...
        <div className="mb-6">
          <label className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl cursor-pointer hover:bg-neutral-100 transition-colors">
            <div>
              <span className="font-medium text-neutral-900">Notificaciones por email</span>
            ...
            <div className="relative">
              ...
              />
              <div className="w-11 h-6 bg-neutral-300 peer-focus:ring-2 peer-focus:ring-gold-dark rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gold-dark"></div>
            </div>
          </label>
        </div>
      </div>
      ...
      <div>
        <h4 className="font-medium text-neutral-900 mb-3">Frecuencia de notificaciones</h4>
      ...
      {/* Priority Bypass */}
      <div>
        <label className="flex items-center justify-between p-4 bg-gold-light border border-gold rounded-xl cursor-pointer hover:bg-gold-light transition-colors">
          <div className="flex items-start gap-3">
            <Zap size={20} className="text-gold-dark mt-0.5 flex-shrink-0" />
            <div>
              <span className="font-medium text-neutral-900">Notificaciones prioritarias inmediatas</span>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <div>
            <h4 className="font-medium text-neutral-900">Horario de silencio</h4>
      ...
      <div className="flex items-center gap-4 pt-4 border-t border-neutral-200">
        ...
        {saveSuccess && (
          <span className="text-sm text-success-dark">Notificaciones actualizadas</span>
        )}
      </div>
    </div>
  )
